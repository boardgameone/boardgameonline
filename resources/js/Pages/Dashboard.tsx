                ...
                <div className="bg-white rounded-3xl shadow-xl overflow-hidden border-b-8 border-yellow-500 dark:bg-gray-800 dark:border-yellow-600">
                    ...
                    <div className="grid grid-cols-3 divide-x divide-gray-100 dark:divide-gray-700">
                        <div className="px-2 sm:px-4 py-5 text-center">
                            <div className="text-2xl sm:text-3xl font-black text-yellow-500 dark:text-yellow-300">
                                {stats?.gamesPlayed ?? 0}
                            </div>
                            <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 font-medium truncate">Games Played</div>
                        </div>
                        <div className="px-2 sm:px-4 py-5 text-center">
                            <div className="text-2xl sm:text-3xl font-black text-green-500 dark:text-green-400">
                                {stats?.wins ?? 0}
                            </div>
                            <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 font-medium truncate">Victories</div>
                        </div>
                        <div className="px-2 sm:px-4 py-5 text-center">
                            <div className="text-2xl sm:text-3xl font-black text-blue-500 dark:text-blue-400">
                                {stats?.totalPlayTime ?? 0}h
                            </div>
                            <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 font-medium truncate">Play Time</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 mb-8">
                ...
                >
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="font-bold text-gray-900 text-lg dark:text-gray-100">Browse Games</h3>
                            <p className="text-gray-500 text-sm dark:text-gray-400">Find your next adventure</p>
                        </div>
                    </div>
                </Link>
                ...
                >
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="font-bold text-gray-900 text-lg dark:text-gray-100">Join Room</h3>
                            <p className="text-gray-500 text-sm dark:text-gray-400">Enter a room code</p>
                        </div>
                    </div>
                </Link>
                ...
                >
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="font-bold text-gray-900 text-lg dark:text-gray-100">Your Profile</h3>
                            <p className="text-gray-500 text-sm dark:text-gray-400">Customize your account</p>
                        </div>
                    </div>
                </Link>
            </div>
                    ...
                    <div className="p-6">
                        {activeRooms.length > 0 ? (
                            <div className="space-y-3">
                                {activeRooms.map((room) => (
                                    <Link
                                        ...
                                        className="flex items-center justify-between p-4 rounded-xl bg-gray-50 hover:bg-yellow-50 transition border-2 border-transparent hover:border-yellow-300 dark:bg-gray-700/40 dark:hover:bg-yellow-900/20 dark:hover:border-yellow-700"
                                    >
                            ...
                            <div className="text-center py-8">
                                <div className="mb-3 opacity-50 flex justify-center text-gray-400 dark:text-gray-500">
                                    <GameIcon name="gamepad" size="xl" />
                                </div>
                                <p className="text-gray-500 font-medium dark:text-gray-400">No active rooms</p>
                                <Link
                                    href={route('games.index')}
                    ...
                    <div className="p-6">
                        {recentGames.length > 0 ? (
                                ...
                                {recentGames.slice(0, 4).map((game) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <p className="font-bold text-gray-900 truncate dark:text-gray-100">
                                                {game.name}
                                            </p>
                                            <p className="text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <div className="text-center py-8">
                                ...
                                <p className="text-gray-500 font-medium dark:text-gray-400">Discover new games</p>
                                <Link
                                    href={route('games.index')}
