            ...
            <div
                className={`rounded-lg border-2 transition-all duration-300 animate-slideIn ${
                    ...
                    player.is_current_turn
                        ? 'border-yellow-400 bg-linear-to-r from-yellow-50 to-yellow-100 shadow-lg dark:border-yellow-600 sepia:border-sepia-accent-border dark:from-yellow-900/30 sepia:from-sepia-accent-bg/30 dark:to-yellow-800/30 sepia:to-sepia-accent-bg/30'
                        : 'border-gray-200 bg-white dark:border-gray-700 sepia:border-sepia-border dark:bg-gray-800 sepia:bg-sepia-surface'
                } ${
            ...
            >
                <div className={`flex items-center justify-between ${compact ? '' : 'mb-2'}`}>
                    <div className={`flex items-center ${compact ? 'gap-2' : 'gap-3'}`}>
                        ...
                        {/* Player info */}
                        <div>
                            <p className={`font-bold text-gray-900 flex items-center gap-1 dark:text-gray-100 sepia:text-sepia-text ${compact ? 'text-sm' : ''}`}>
                                ...
                                {player.is_current_turn && (
                                    <span className={`bg-yellow-100 text-yellow-700 rounded-full font-semibold dark:bg-yellow-900/40 sepia:bg-sepia-accent-bg/40 dark:text-yellow-300 sepia:text-sepia-accent ${
                                        compact ? 'text-[10px] px-1' : 'text-xs px-2 py-0.5'
                                    }`}>
                                        Turn
                                    </span>
                            ...
                            <div className={`flex items-center gap-2 text-gray-600 dark:text-gray-400 sepia:text-sepia-muted ${compact ? 'text-xs' : 'text-sm mt-1'}`}>
                ...
                {player.collected_trios.length > 0 && (
                    <div className={compact ? 'mt-2 pt-2 border-t border-gray-200 dark:border-gray-700 sepia:border-sepia-border' : 'mt-3 pt-3 border-t border-gray-200 dark:border-gray-700 sepia:border-sepia-border'}>
