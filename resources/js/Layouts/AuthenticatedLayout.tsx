...
export default function Authenticated({
    ...
    return (
        <div className="min-h-screen bg-linear-to-b from-yellow-400 to-yellow-500 dark:from-gray-900 sepia:from-sepia-bg dark:to-gray-950 sepia:to-sepia-surface transition-colors duration-200">
            {/* Nav */}
            <nav className="relative">
                {/* Gradient Background */}
                <div className="absolute inset-0 bg-linear-to-r from-indigo-600 via-purple-600 to-pink-500" />
                ...
                <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="flex h-16 sm:h-20 justify-between items-center">
                        ...
                        <div className="flex items-center gap-2 sm:gap-6">
                            ...
                            <Link href="/" className="flex items-center gap-2 sm:gap-3 group">
                                <div className="relative">
                                    <div className="absolute inset-0 bg-yellow-400 rounded-xl blur-xs opacity-50 group-hover:opacity-75 transition" />
                        ...
                        <div className="hidden sm:flex items-center gap-3">
                            <AudioControls variant="authenticated" />
                            <Dropdown>
                                <Dropdown.Trigger>
                                    <button
                                        type="button"
                ...
                <div className="absolute bottom-0 left-0 right-0 h-1 bg-linear-to-r from-yellow-400 via-pink-500 to-purple-500" />
            </nav>
